...
func (rcv *Posting) ValueType() PostingValueType {
...
func (rcv *Posting) MutateValueType(n PostingValueType) bool {
...
func (rcv *Posting) Op() DirectedEdgeOp {
...
func (rcv *Posting) MutateOp(n DirectedEdgeOp) bool {
...
func PostingAddValueType(builder *flatbuffers.Builder, valueType PostingValueType) {
...
func PostingAddLangTag(builder *flatbuffers.Builder, langTag flatbuffers.UOffsetT) {
	builder.PrependUOffsetTSlot(3, flatbuffers.UOffsetT(langTag), 0)
}
...
func PostingAddFacets(builder *flatbuffers.Builder, facets flatbuffers.UOffsetT) {
	builder.PrependUOffsetTSlot(5, flatbuffers.UOffsetT(facets), 0)
}
func PostingStartFacetsVector(builder *flatbuffers.Builder, numElems int) flatbuffers.UOffsetT {
	return builder.StartVector(4, numElems, 4)
}
func PostingAddOp(builder *flatbuffers.Builder, op DirectedEdgeOp) {
	builder.PrependInt32Slot(6, int32(op), 0)
}
func PostingAddStartTs(builder *flatbuffers.Builder, startTs uint64) {
	builder.PrependUint64Slot(7, startTs, 0)
}
func PostingAddCommitTs(builder *flatbuffers.Builder, commitTs uint64) {
	builder.PrependUint64Slot(8, commitTs, 0)
}
